class Api::V1::PayPalController < Api::V1::ApiController
  ...
  def notify_host_payment_has_been_sent_from_swapper(connection)
    ...
    Notification.create(subject: "Payment Transfer", body: "Swapper #{connection.swapper.name} has been sent payment of $#{amount}.00", notify_by: "Swapper", swapper_id: connection.swapper_id, host_id: connection.host_id)
  end
